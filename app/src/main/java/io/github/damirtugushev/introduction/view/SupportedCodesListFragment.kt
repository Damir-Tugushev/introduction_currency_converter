...
import io.github.damirtugushev.introduction.databinding.SupportedCodesListFragmentBinding
...
import io.github.damirtugushev.introduction.view.adapters.SupportedCodeViewHolder
import io.github.damirtugushev.introduction.view.adapters.SupportedCodesListAdapter
import io.github.damirtugushev.introduction.view.decorations.MarginDecoration
...
class SupportedCodesListFragment : Fragment() {
    ...
    private var _binding: SupportedCodesListFragmentBinding? = null
    ...
    ): View = SupportedCodesListFragmentBinding.inflate(inflater, container, false)
                ...
                when (newState) {
                    State.Saved -> {
                        viewModel.save(supportedCode).handle {
                            snackbarShort(binding.root) {
                                "Code ${supportedCode.code} was saved successfully"
                            }.show()
                            showDelete()
                        }
                    ...
                    State.Deleted -> {
                        ...
                        snackbarShort(binding.root) {
                            "Code ${supportedCode.code} was deleted successfully"
                        }.show()
                        showSave()
                        activity.hideProgress()
                    }
