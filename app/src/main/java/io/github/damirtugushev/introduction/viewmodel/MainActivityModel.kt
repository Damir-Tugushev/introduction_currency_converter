...
import io.github.damirtugushev.introduction.repository.ApiResponse
import io.github.damirtugushev.introduction.repository.ExchangeRateAPI
import io.github.damirtugushev.introduction.repository.model.parse
...
class MainActivityModel(private val exchangeRateAPI: ExchangeRateAPI) : ViewModel() {
    ...
    private suspend fun updateSupportedCodes(): ApiResponse<List<SupportedCode>> =
